...
class Admin {
	...
	/**
	 * Render add-record section.
	 *
	 * @param array<int,\WP_Post> $courses Courses loaded from Tutor LMS post type.
	 * @param bool                 $tutor_lms_active Whether Tutor LMS dependency is available.
	 * @return void
	 */
