			...
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td><input type="text" id="student_name" name="student_name" class="regular-text" required <?php disabled( ! $tutor_lms_active ); ?> /></td>
					</tr>
					<tr>
						<th scope="row"><label for="course_id"><?php esc_html_e( 'Course Name', 'student-certificate-verification' ); ?></label></th>
						<td>
							<select id="course_id" name="course_id" required <?php disabled( ! $tutor_lms_active ); ?>>
					...
					<tr>
						...
						<td><input type="text" id="certificate_number" name="certificate_number" class="regular-text" required <?php disabled( ! $tutor_lms_active ); ?> /></td>
					</tr>
				</table>
				<?php submit_button( __( 'Add Record', 'student-certificate-verification' ), 'primary', 'submit', true, array( 'disabled' => ! $tutor_lms_active ) ); ?>
			</form>
